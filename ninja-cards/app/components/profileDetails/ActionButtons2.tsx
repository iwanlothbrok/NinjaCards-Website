    ...
    return (
        <div className="flex flex-col space-y-4 mb-8">
            ...
            <button
                ...
                className="flex items-center justify-center bg-white text-black px-8 py-4 rounded-full shadow-xl hover:shadow-2xl hover:bg-gray-200 transition-all transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50 w-full sm:w-auto"
            >
