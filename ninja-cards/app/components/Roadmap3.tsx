      ...
      <div className="max-w-5xl mx-auto w-full px-4 sm:px-6">
        <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {roadmapSteps.map((step, index) => (
            <li
              key={index}
              className="relative flex flex-col items-center bg-gray-800 rounded-xl shadow-lg p-6 transform transition-transform duration-300 hover:bg-orange group hover:scale-105 hover:text-black group-hover:shadow-2xl mb-8"
            >
