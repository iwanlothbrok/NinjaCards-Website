...
const ImportantLinks: React.FC = () => {
    ...
    return (
        <div className='p-4'>
            <div className="w-full max-w-3xl mx-auto mt-28 p-6 sm:p-10 bg-gradient-to-b from-gray-900 to-gray-800 rounded-2xl shadow-xl border border-gray-700">
                <h2 className="text-3xl font-bold mb-6 text-center text-white">🔗 {t('title')}</h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-between items-center mt-6 col-span-2">
                        ...
                        <button
                            type="submit"
                            className="bg-gradient-to-r from-teal-600 to-orange text-white py-3 px-6 rounded-lg hover:opacity-80 ml-auto"
                            disabled={loading}
                        >
