        ...
        <div className="max-w-screen-lg mx-auto p-5">
            <div className="grid grid-cols-1 md:grid-cols-12">
                ...
                <div className="bg-gray-800 md:col-span-4 p-10 text-white">
                    ...
                    />
                    <p className="mt-4 leading-7 text-gray-200">{t("left.description")}</p>

                    <div className="flex items-center mt-5">
                        <FaPhone className="h-6 mr-2 text-orange" />
                        <span className="text-sm">{t("left.phone1")}</span>
                    </div>
                    <div className="flex items-center mt-2">
                        <FaPhone className="h-6 mr-2 text-orange" />
                        <span className="text-sm">{t("left.phone2")}</span>
                    </div>
                    <div className="flex items-center mt-5">
                        <FaEnvelope className="h-6 mr-2 text-orange" />
                        <span className="text-sm">{t("left.email")}</span>
                    </div>
                    <div className="flex items-center mt-5">
                        <FaClock className="h-6 mr-2 text-orange" />
                        <span className="text-sm">{t("left.workingHours")}</span>
                    </div>
                </div>
