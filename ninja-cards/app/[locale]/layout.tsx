...
export const metadata: Metadata = {
  ...
  description:
    "Ninja Cards създава иновативни смарт NFC визитки за професионалисти и бизнеси. Споделяйте контактите си с едно докосване – стилно, бързо и екологично.",
  openGraph: {
    type: "website",
    url: "https://www.ninjacardsnfc.com/",
    title: "Ninja Cards NFC | Смарт NFC Визитки за Модерен Бизнес",
    description:
      "Открийте новото поколение смарт NFC визитки от Ninja Cards – дигитално споделяне на контакти, персонализиран дизайн и устойчивост. Бъдещето на визитките е тук.",
