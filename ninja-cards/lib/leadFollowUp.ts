...
2. If the lead left a message, reference it naturally and show you read it
3. If no message, write a friendly "nice to meet you" style email
4. Keep it short: 3-4 sentences max. No fluff.
5. End with one clear, soft call-to-action
6. Write in the same language the lead's message is in. If no message, write in Bulgarian.
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%">
        <tr><td style="background:#0e1017;border:1px solid rgba(255,255,255,0.07);border-radius:20px 20px 0 0;padding:28px 36px 20px;text-align:center">
          <div style="display:inline-block;background:linear-gradient(135deg,${accent},${accent}cc);border-radius:10px;padding:8px 16px;margin-bottom:14px">
            <span style="font-size:12px;font-weight:900;color:#000;letter-spacing:0.15em;text-transform:uppercase">Ninja Card</span>
          </div>
          <p style="margin:0;font-size:12px;color:#555">Beshe priyatno da se zapoznaem</p>
        </td></tr>
        <tr><td style="height:3px;background:linear-gradient(90deg,transparent,${accent},transparent)"></td></tr>
        <tr><td style="background:#0e1017;border-left:1px solid rgba(255,255,255,0.07);border-right:1px solid rgba(255,255,255,0.07);padding:28px 36px">
          <p style="margin:0 0 16px;font-size:15px;color:#e0e0e0;font-weight:600">Zdravei, ${firstName}</p>
          <p style="margin:0;font-size:14px;color:#aaa;line-height:1.8;white-space:pre-line">${body}</p>
        </td></tr>
        <tr><td style="background:#0e1017;border-left:1px solid rgba(255,255,255,0.07);border-right:1px solid rgba(255,255,255,0.07);padding:0 36px 28px">
          <div style="height:1px;background:rgba(255,255,255,0.05);margin-bottom:20px"></div>
          <p style="margin:0;font-size:12px;color:#555">S uvazhenie,<br><strong style="color:#888">${ownerName}</strong></p>
        </td></tr>
        <tr><td style="background:#080a0f;border:1px solid rgba(255,255,255,0.07);border-top:none;border-radius:0 0 20px 20px;padding:18px 36px;text-align:center">
          <p style="margin:0;font-size:10px;color:#333">Izprateno chrez Ninja Card</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
